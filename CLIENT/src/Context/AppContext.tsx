...
export const AppContextProvider: FC<AppContextProps> = ({ children }) => {
    ...
    const getAllImages = async () => {
        try {
            ...
            const response = await axios.get("http://localhost:4000/api/allImages")
    ...
    const handleTitleUpdate = async () => {
        try {
            ...
            await axios.put(`http://localhost:4000/api/image/${selectedImageId}`, payload)
    ...
    const handleImageDelete = async () => {
        try {
            ...
            await axios.delete(`http://localhost:4000/api/image/${selectedImageId}`)
